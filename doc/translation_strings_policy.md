...
This document provides guidelines for internationalization of the KekCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `kekcoin_en.ts` remains unchanged.

...
class RawTransactionsTest(KekCoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid kekcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid kekcoin address" in e.error['message'])

...
#define BOOST_TEST_MODULE KekCoin Test Suite

#include "test_kekcoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_kekcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));

...
#ifndef KEKCOIN_TEST_SCRIPTNUM10_H
#define KEKCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from KekCoin Core 0.10.0, for cross-comparison.
 */
public:

...
#ifndef UI_KEKTECHINIT_H
#define UI_KEKTECHINIT_H
...
public:
    ...
    void retranslateUi(QDialog *NavTechInit)
    {
        ...
        label->setText(QApplication::translate("NavTechInit", "KekCoin uses an unique parallel cluster of nodes called NavTech to protect the privacy of your transactions.", Q_NULLPTR));
        label_2->setText(QApplication::translate("NavTechInit", "You will find below the list of the KekCoin Foundation Servers. Feel free to modify this list to include your prefered servers:", Q_NULLPTR));

...
#ifndef KEKCOIN_QT_WALLETFRAME_H
#define KEKCOIN_QT_WALLETFRAME_H
...
public:
    explicit WalletFrame(const PlatformStyle *platformStyle, KekCoinGUI *_gui = 0);
    ~WalletFrame();
...
#endif // KEKCOIN_QT_WALLETFRAME_H

...
#ifndef KEKCOIN_QT_KEKCOINUNITS_H
#define KEKCOIN_QT_KEKCOINUNITS_H
...
/** KekCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class KekCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit KekCoinUnits(QObject *parent);

    /** KekCoin units.
      @note Source: https://en.kekcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        KEK,
...
typedef KekCoinUnits::Unit KekCoinUnit;

#endif // KEKCOIN_QT_KEKCOINUNITS_H

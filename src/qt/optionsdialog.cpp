    ...
    mapper(0)
{
    ...
    ui->kekcoinAtStartup->setToolTip(ui->kekcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->kekcoinAtStartup->setText(ui->kekcoinAtStartup->text().arg(tr(PACKAGE_NAME)));
...
{
    /* Main */
    mapper->addMapping(ui->kekcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openKekCoinConfButton_clicked()
{

...
public:
    TxViewDelegate(const PlatformStyle *platformStyle):
        QAbstractItemDelegate(), unit(KekCoinUnits::KEK),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        QString amountText = KekCoinUnits::formatWithUnit(unit, amount, true, KekCoinUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& stakingBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(KekCoinUnits::formatWithUnit(unit, balance, false, KekCoinUnits::separatorAlways));
    ui->labelUnconfirmed->setText(KekCoinUnits::formatWithUnit(unit, unconfirmedBalance, false, KekCoinUnits::separatorAlways));
    ui->labelStaking->setText(KekCoinUnits::formatWithUnit(unit, stakingBalance, false, KekCoinUnits::separatorAlways));
    ui->labelImmature->setText(KekCoinUnits::formatWithUnit(unit, immatureBalance, false, KekCoinUnits::separatorAlways));
    ui->labelTotal->setText(KekCoinUnits::formatWithUnit(unit, balance + unconfirmedBalance + stakingBalance, false, KekCoinUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("KEK")
    updateDisplayUnit();
}
...
void OverviewPage::updateStakeReport(bool fImmediate=false)
{
    ...
    ui->label24hStakingStats->setText(KekCoinUnits::formatWithUnit(unit, aRange[i++].Total, false, KekCoinUnits::separatorAlways));
    ui->label7dStakingStats->setText(KekCoinUnits::formatWithUnit(unit, aRange[i++].Total, false, KekCoinUnits::separatorAlways));
    ui->label30dStakingStats->setText(KekCoinUnits::formatWithUnit(unit, aRange[i++].Total, false, KekCoinUnits::separatorAlways));

...
bool EvalScriptKekcoin(vector<vector<unsigned char> >& stack, const CScript& script, const CTransaction& txTo, const BaseSignatureCheckerKekcoin& checker, unsigned int nIn, unsigned int flags, int nHashType)
{
    static const CScriptNum bnZero(0);
    static const CScriptNum bnOne(1);
    static const CScriptNum bnFalse(0);
...
bool EvalScriptKekcoin(vector<vector<unsigned char> >& stack, const CScript& script, unsigned int flags, const BaseSignatureCheckerKekcoin& checker, ScriptError* serror)
{
    static const CScriptNum bnZero(0);
    static const CScriptNum bnOne(1);
    static const CScriptNum bnFalse(0);

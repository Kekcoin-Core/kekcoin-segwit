...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", KEKCOIN_CONF_FILENAME));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
        return; // No kekcoin.conf file is OK
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", KEKCOIN_PID_FILENAME));

...
unlocked to sign the KekCoin-Qt.app bundle.
...
allowing somebody to distribute a KekCoin-Qt.app or kekcoin-qt-setup.exe with a valid
...
that the kekcoin-qt.exe file inside the installer had not been tampered with.
